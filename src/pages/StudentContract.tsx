        ...
        <Card className="mb-6">
          ...
          <CardContent className="space-y-4">
            <div className="prose prose-sm dark:prose-invert max-w-none">
              ...
              <p className="text-sm leading-relaxed mb-4">
                The Employee will receive compensation between 15,000 - 20,000 kr per month, based on hours worked and performance. 
                Payment will be made monthly, within 5 business days after the end of each month. All payments comply with Norwegian tax regulations.
              </p>
